                ...
                <div class="col-lg-6">
                    <div class="contact-content">
                        <div class="sec-title white">
                            ...
                            <h2 class="title animated-heading">Automate Your Delivery Operations</h2>
                            <p>Contact us to learn how delivery robots can transform your business.</p>
                        </div>
                        <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form action="#" method="post" class="custom-form">
                            ...
                            <textarea name="message" rows="3" placeholder="Tell us about your delivery needs..."
                                required></textarea>
